...
#define AI_NETWORK_MODEL_SIGNATURE     "0x96571b7b3b094bd6b4bec70c893e4913"
...
#define AI_TOOLS_DATE_TIME   "2026-03-24T09:03:08+0300"
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    96, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_IN_NUM, &serving_default_keras_tensor_100_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_OUT_NUM, &nl_3_output),
  &gemm_0_layer, 0x197ad56c, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    serving_default_keras_tensor_100_output_array.data = AI_PTR(g_network_activations_map[0] + 28);
    serving_default_keras_tensor_100_output_array.data_start = AI_PTR(g_network_activations_map[0] + 28);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    gemm_1_bias_array.data = AI_PTR(g_network_weights_map[0] + 640);
    gemm_1_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 640);
    ...
    gemm_2_bias_array.data = AI_PTR(g_network_weights_map[0] + 704);
    gemm_2_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 704);
    return true;
  }
